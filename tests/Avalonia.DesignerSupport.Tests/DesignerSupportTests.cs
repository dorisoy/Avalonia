...
namespace Avalonia.DesignerSupport.Tests
{
    ...
    {
        private const string DesignerAppPath = "../../../../../src/tools/Avalonia.Designer.HostApp/bin/$BUILD/net5.0/Avalonia.Designer.HostApp.dll";
        ...
        [SkippableTheory,
         InlineData(
            @"..\..\..\..\..\tests/Avalonia.DesignerSupport.TestApp/bin/$BUILD/net5.0/",
